...
app = FastAPI(
    ...
    description="XX Bank AI Customer Service — Sprint 6 (LangGraph: Router/FAQ/Account/CardLoss/Handoff/Logger)",
    version="6.0.0",
)
...
def health():
    ...
    return {
        "status": "ok",
        "sprint": 6,
        "mode": "LangGraph (Router -> FAQ/Account/CardLoss/Handoff/Logger)",
